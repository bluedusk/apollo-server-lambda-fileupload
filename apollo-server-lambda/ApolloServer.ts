	...
	public createHandler({ cors }: CreateHandlerOptions = { cors: undefined }) {
		...
		return (
			...
			if (event.httpMethod === "OPTIONS") {
				/**
				 * This could be a fix to the issue:
				 * https://sportsbet.atlassian.net/browse/RO-907
				 * Since ApolloServer already disable callbackWaitsForEmptyEventLoop for POST request.
				 * (https://github.com/apollographql/apollo-server/blob/cb50f21f0110569cf1822862ea1f79b911de39e1/packages/apollo-server-lambda/src/lambdaApollo.ts#L33)
				 * It seems OK to bypass this check for OPTIONS as well since OPTIONS is just for CORS and suppose to return immediately.
				 */
